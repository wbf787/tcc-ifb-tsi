...
% ---
% 1. CORREÇÃO COMPLETA DE CONFLITOS COM REGEXPATCH (TeX Live 2026)
% ---
\makeatletter
\AddToHook{file/before/regexpatch.sty}{%
  \let\xshowcmd\@undefined
  \let\xpretocmd\@undefined
  \let\xapptocmd\@undefined
  \let\xpatchcmd\@undefined
}
\makeatother
